...
public enum ResponseCodeEnum {
   ...
   * 业务相关异常
   */
  BIZ_CHECK_FAIL("BIZ-0001", ErrorLevels.INFO, ErrorTypes.BIZ, "业务检查异常"), BIZ_STATUS_ILLEGAL(
      "BIZ-0002", ErrorLevels.INFO, ErrorTypes.BIZ,
      "业务状态非法"), BIZ_QUERY_EMPTY("BIZ-0003", ErrorLevels.INFO, ErrorTypes.BIZ, "查询信息为空"),
  /**
   * 系统出错
   */
  ...
  class ErrorLevels {
    public static final String DEFAULT = "DEFAULT", INFO = "INFO", ERROR = "ERROR";
  }
  class ErrorTypes {
    public static final String SYSTEM = "SYSTEM", BIZ = "BIZ";
  }
}
