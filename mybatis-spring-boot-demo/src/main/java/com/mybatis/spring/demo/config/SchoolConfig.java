...
@MapperScan(basePackages = "com.mybatis.spring.demo.school.mapper", sqlSessionFactoryRef = "schoolSqlSessionFactory")
@Setter
public class SchoolConfig {
    ...
    public DataSource unionDataSource() {
        ...
        dataSource.setPoolName("school_" + dbProperties.getPoolName());
     ...
     */
    @Role(100)
    @Bean(name = CmsConst.TRANSACTION_SCHOOL)
    ...
    public SqlSessionFactory unionSqlSessionFactory(@Qualifier("schoolDataSource") DataSource dataSource)
            throws Exception {
        ...
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:mapper/school/*.xml"));
